                ...
                <div class="card mt-4">
                    ...
                    <div class="card-footer">
                        ...
                        <a href="index.php?cat=<?php echo $row['cat_id']; ?>" class="float-right">
                            ...
                            $cat_id= $row['cat_id'];
                            $get_cat_id= mysqli_query($connection,"SELECT * FROM category WHERE id='$cat_id'");
                            $get_cat_row= mysqli_fetch_array($get_cat_id);
